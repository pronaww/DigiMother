            ...
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Bitmap scaledBitmap = Bitmap.createScaledBitmap(original, original.getWidth(), original.getHeight(), false);
                        Bitmap rotatedBitmap = Bitmap.createBitmap(scaledBitmap, 0, 0, scaledBitmap.getWidth(), scaledBitmap.getHeight(), matrix, false);
                        transformed = rotatedBitmap;//((ScanActivity) getActivity()).getBWBitmap(original);
